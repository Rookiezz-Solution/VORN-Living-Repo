...
const AdminProfile = () => {
  ...
  return (
    <div className="space-y-4 rf-fade-in">
      ...
      <div className="rf-card p-5 space-y-3 bg-surface">
        <div className="text-sm text-secondary/70">Signed in as</div>
        <div className="text-lg font-semibold text-secondary">{email || 'Admin'}</div>
        <div className="flex items-center gap-2 pt-2">
          <button
            type="button"
            className="border border-border px-4 py-2 rounded-xl bg-surface hover:bg-surface-2 transition"
