        ...
        <div className="fixed inset-0 z-[1000] bg-black/40 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="rf-card w-full max-w-2xl p-6 shadow-xl">
            ...
            <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
              <div className="rf-card p-4 flex flex-col items-center justify-center">
                <div className="h-40 w-40 rounded-xl border border-border overflow-hidden bg-gray-50 mb-4">
                  <ProductImage
