...
const Header = () => {
    ...
    return (
        <header className="bg-secondary text-white border-b border-border sticky top-0 z-50 shadow-sm">
            {/* Top Bar */}
            <div className="bg-primary text-secondary py-2 text-sm">
            ...
            <div className="container mx-auto py-4 flex justify-between items-center relative">
                ...
                <Link to="/" className="flex items-center">
                    <img
                        ...
                        alt="Vorn Living"
                        className="h-12 md:h-14 w-auto max-w-[240px] sm:max-w-[320px] md:max-w-[380px] object-cover rounded-[18%]"
                        loading="eager"
                        decoding="async"
                    />
                </Link>
                ...
                <div className="flex items-center space-x-3 text-white">
                    ...
                    {/* Mobile Menu Button */}
                    <button className="md:hidden rf-icon-btn hover:bg-white/10 text-white" onClick={() => setIsMenuOpen(!isMenuOpen)}>
            ...
            <nav className="hidden md:block bg-secondary text-white border-t border-border/40">
