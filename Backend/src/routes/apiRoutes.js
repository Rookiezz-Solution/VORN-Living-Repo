...
router.post('/products', productController.getAllProducts); // Support POST for filtering/fetching
router.post('/products/filter', productController.getAllProducts); // Maintain backward compatibility
